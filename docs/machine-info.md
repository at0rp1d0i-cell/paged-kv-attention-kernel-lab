...
```text
hostname: autodl-container-184148a2a3-47a386c7
user: root
uid/gid: uid=0(root) gid=0(root) groups=0(root)
working_dir: /root/paged-kv-attention-kernel-lab
kernel: Linux autodl-container-184148a2a3-47a386c7 5.15.0-119-generic #129-Ubuntu SMP Fri Aug 2 19:25:20 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
...
overlay          30G   11G   20G  36% /
overlay          30G   11G   20G  36% /

NAME      SIZE TYPE  MOUNTPOINT                                        FSTYPE MODEL
sda     894.3G disk                                                           SAMSUNG MZ7L3960
├─sda1      1G part
└─sda2  893.2G part  /usr/lib/firmware/nvidia/580.105.08/gsp_tu10x.bin
nbd0        0B disk
nbd1        0B disk
nbd2        0B disk
nbd3        0B disk
...
| 41%   28C    P8              9W /  575W |       0MiB /  32607MiB |      0%      Default |
|                                         |                        |                  N/A |
+-----------------------------------------+------------------------+----------------------+
...
nvidia-smi query:
0, NVIDIA GeForce RTX 5090, 32607 MiB, 32110 MiB, 580.105.08, 00000000:A8:00.0, 575.00 W, 180 MHz, 405 MHz, 3090 MHz, 14001 MHz, 12.0
