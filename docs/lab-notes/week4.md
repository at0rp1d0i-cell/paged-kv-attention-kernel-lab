...
```text
B=1:    8 programs, 约 265 GB/s, 15%
B=8:   64 programs, 约 1562 GB/s, 87%
B=16: 128 programs, 约 1684 GB/s, 94%
B=32: 256 programs, 约 1693 GB/s, 94.5%
```
...
`torch.profiler` 显示 PyTorch dense SDPA 在 `q_len=1`、长 context 下实际调用
